...
export const EditResumePage = () => {
  ...
  const onSectorSelect = async (sect: Sector) => {
    setSectorType(sect);
    setResumeData({ ...resumeData, selectedSector: sect });
  };
          ...
          {message.message
            ...
            : (
              ...
              >
                ...
                {!resumeData.isSectorsLoaded ? <Loader />
                  : (
                    <FormControl
                      fullWidth
                      sx={{
                    ...
                    >
                      ...
                      <Select
                        ...
                        onChange={(e) => {
                          const sec = resumeData.sectors?.find((s) => s.id === e.target.value);
                          sec && onSectorSelect(sec);
                        }}
                      >
                ...
                {resumeData.loadingOther ? <Loader />
                  : resumeData.isOthersLoaded && (
                  <>
                    <FormControl
                      fullWidth
